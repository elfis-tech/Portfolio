...
// Correction : Il manque un point devant 'navigation'
...
const scrollActive = () => {
    sections.forEach(section => {
        ...
        if (top >= offset && top < offset + height) {
            ...
            // Correction : Ajouter les guillemets pour l'interpolation de chaîne
...
const typed = new Typed('.multiple', {
    strings: ["Développeur web", "Web Designer", "Back-end Développeur", "Développeur en Domotique"],
    typeSpeed: 100,
    backSpeed: 100,
    backDelay: 1000,
    loop: true
